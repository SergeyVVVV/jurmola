...
const translations = {
  pageTitle: "Business in Jurmala",
  pageDescription: "Economic satire from the Baltic business hub. Market analysis, startup stories, and suspiciously successful potato ventures.",
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'website',
    images: [{ url: 'https://jurmola.com/images/grey-day-creature.jpg', width: 1200, height: 630, alt: 'Jurmola Telegraphs – Business' }],
  },
  twitter: {
