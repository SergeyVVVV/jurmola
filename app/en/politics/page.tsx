...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'en_US',
    type: 'website',
    images: [{ url: 'https://jurmola.com/images/grey-day-creature.jpg', width: 1200, height: 630, alt: 'Jurmola Telegraphs – Politics' }],
  },
  twitter: {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <LoadMoreArticles 
          articles={toArticleCards(politicsArticles, language)}
          language={language}
          initialCount={18}
          loadMoreCount={15}
        />
