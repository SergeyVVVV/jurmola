      ...
      <section className="bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 py-16">
        <div className="max-w-4xl mx-auto px-4">
          <nav className="text-sm text-gray-500 mb-6">
            <Link href={localizedHref('jurmola', language)} className="hover:text-orange-600 transition-colors">Путеводитель по Юрмале</Link>
            <span className="mx-2">/</span>
            <span className="text-gray-900">Рестораны, бары и кафе</span>
          </nav>
          <p className="text-sm font-medium text-orange-600 mb-3 tracking-wide uppercase">Гид по ресторанам 2026</p>
          <h1 className="text-5xl font-bold mb-6 leading-tight">Лучшие рестораны, бары и кафе Юрмалы</h1>
          ...
          <p className="text-lg text-gray-500">Большинство ресторанов расположено на пешеходной улице Йомас (Jomas iela).</p>
        </div>
      </section>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-14">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold">Рестораны высокой кухни</h2>
          </div>
        ...
        <section className="mb-14">
          <div className="flex items-center gap-3 mb-6">
            <span className="text-3xl">&#127869;</span>
            <h2 className="text-3xl font-bold">Рестораны и кухни мира</h2>
          </div>
        ...
        <section className="mb-14">
          <div className="flex items-center gap-3 mb-6">
            <span className="text-3xl">&#9749;</span>
            <h2 className="text-3xl font-bold">Кафе и кофейни</h2>
          </div>
        ...
        <section className="mb-14">
          <div className="flex items-center gap-3 mb-6">
            <span className="text-3xl">&#127867;</span>
            <h2 className="text-3xl font-bold">Бары и ночная жизнь</h2>
          </div>
        ...
        <section className="mb-14 p-6 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border border-blue-200">
          <h2 className="text-2xl font-bold mb-2">Планируете поездку в Юрмалу?</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold mb-6">Другие разделы путеводителя</h2>
